...
### plot_area_results
[source](https://github.com/allfed/Seaweed-Upscaling-Model/blob/master/src/plotter.py/#L70)
```python
.plot_area_results(
   clusters
)
...
### plot_self_shading
[source](https://github.com/allfed/Seaweed-Upscaling-Model/blob/master/src/plotter.py/#L94)
```python
.plot_self_shading()
```
