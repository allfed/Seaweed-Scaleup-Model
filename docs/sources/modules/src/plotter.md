...
### plot_area_results
[source](https://github.com/allfed/Seaweed-Upscaling-Model/blob/master/src/plotter.py/#L237)
```python
.plot_area_results(
   clusters, scenario
)
...
### plot_self_shading
[source](https://github.com/allfed/Seaweed-Upscaling-Model/blob/master/src/plotter.py/#L275)
```python
.plot_self_shading()
```
